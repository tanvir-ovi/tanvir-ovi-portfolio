...
const paragraphs = [
  ...
  `I finished my BSc in November 2025. Since July of that year I have been a remote research assistant in the Biometric Intelligence and Vision Laboratory at the State University of New York, Canton, supervised by Dr. A M Mahmud Chowdhury, with Dr. Nazmul Siddique of Ulster University co-supervising the neural signal work. That appointment is where most of my recent first-author papers come from, including the move from scalp EEG into intracranial recordings.`,
  `Alongside the lab work I am applying to graduate research positions, mostly PhD and a few research master's programs, across several countries. The plan after that has not changed in a while. I want to come back to Bangladesh and start a small lab focused on assistive brain-computer interfaces, beginning with patients who have motor neuron disease and currently get very little support in our health system. The papers, the applications, the late nights with noisy EEG recordings, all of it is really in service of that.`,
];
